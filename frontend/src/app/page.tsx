...
export default function CalendarApp() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden', backgroundColor: '#f8f9fa' }}>
      ...
      >
        <Toolbar sx={{ minHeight: '64px !important', px: 2, gap: 0.5 }}>
          ...
          <Menu
            ...
            slotProps={{ paper: { sx: { borderRadius: '12px', minWidth: 220, mt: 0.5, boxShadow: '0 4px 20px rgba(0,0,0,0.15)' } } }}
          >
            <Box sx={{ px: 2, py: 1.5 }}>
      ...
      <Dialog open={collisionDialog.open} onClose={handleCancelCollision} slotProps={{ paper: { sx: { borderRadius: '12px' } } }}>
